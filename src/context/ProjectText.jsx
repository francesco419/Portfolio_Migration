/**portfolio*/
import port1 from "@projectImage/portfolio/1.webp";
import port2 from "@projectImage/portfolio/2.webp";
import port3 from "@projectImage/portfolio/3.webp";
/**youtube */
import youtube1 from "@projectImage/youtube/youtube1.webp";
import youtube2 from "@projectImage/youtube/youtube2.webp";
import youtube3 from "@projectImage/youtube/youtube3.webp";
/**travel */
import travel1 from "@projectImage/travel/1.webp";
import travel2 from "@projectImage/travel/2.webp";
import travel3 from "@projectImage/travel/3.webp";
/**social */
import social1 from "@projectImage/sns/1.webp";
import social2 from "@projectImage/sns/2.webp";
import social3 from "@projectImage/sns/3.webp";
import social4 from "@projectImage/sns/4.webp";
/**mindmap */
import mindmap1 from "@projectImage/mindmap/mindmap1.webp";
import mindmap2 from "@projectImage/mindmap/mindmap2.webp";
import mindmap3 from "@projectImage/mindmap/mindmap3.webp";
/**finedition */
import finedition_home from "@projectImage/finedition/finedition-home.webp";
import finedition_food from "@projectImage/finedition/finedition-food.webp";
import finedition_place from "@projectImage/finedition/finedition-place.webp";
import finedition_seoul from "@projectImage/finedition/finedition-seoul.webp";
...
export const ProjectDetailText = [
    {
        ...
        name: "Finedition",
        show: true,
        intro: "현직 디자이너와 협업하여 창업을 준비하는 사람의 요구에 맞춰 사업의 기반이 될 수 있는 웹페이지의 프로토타입을 제작, 한국 관광공사에서 진행하는 공모전에서 수상",
        text2: "현재까지 익힌 기술들을 토대로 현직 디자이너와 협업하여 의뢰자의 요구에 맞게 디자인, 기능 등 웹페이지의 모든 요소를 제작하였습니다. 프로젝트 진행과정에 있어 협업에 대한 경험과 이해를 쌓고, 요구사항에 대해서는 이를 어떻게 구현할지에 대한 문제를 토의를 통해 만족할 수 있는 해결책을 찾고, 다양한 오류들을 해결해가는 시간들을 통해 풀어야할 다양한 형태의 문제에 보다 능숙한 처리 능력을 가지고자 임했습니다.",
        mission: null,
    ...
    },
    {
        ...
        name: "MindMap",
        show: true,
        intro: "사용자와 보다 더 상호작용을 할 수 있는 기능을 가진 마인드맵을 구성할 수 있는 웹사이트 제작, 서로 상관관계에 있는 여러 코드들의 복잡한 구성과 이에대한 연쇄적인 오류 해결능력",
        text2: "기존 마인드맵 웹사이트의 회원가입,로그인과 복잡한 가이드 등의 불편함을 해소하고자 남녀노소 누구나 보기에 직관적이고 쉽게 마인드맵을 구성할 수 있도록 해당 프로젝트를 시작하였습니다. 서버통신없이 오직 기능적인 부분만을 고려하여 제작하게 되었고, 이 프로젝트를 진행하면서 일반적인 웹사이트와 다른 기능적인 면을 제공하는 분야에 관심을 가지게 되었고 특히 발생하는 연쇄적인 오류에 문제를 파악하고 능숙하게 해결하는 실력을 크게 향상하는 계기가 되었습니다.",
        mission: null,
    ...
    },
    {
        ...
        name: "Social Network",
        show: true,
        intro: "프론트엔드와 백엔드의 기술을 사용하여 회원가입, 로그인, 게시물 등록 등의 기능을 포함한 SNS 형태의 웹페이지입니다.",
        text2: "실제 직무에서는 프론트엔드와 백엔드의 협업이 필수적이기에 기초적인 백엔드의 기술들을 학습하여 프론트엔드에서 서버로 요청, 백엔드에서 받은 요청을 수행, 데이터를 DB에 저장 및 읽어와서 프론트엔드에 표현하는 전체적인 통신 및 데이터 교환에 대한 학습을 목표로 한 프로젝트입니다.\n이를 바탕으로 로그인, 회원가입, 게시물 관리 등 백엔드와의 통신이 비교적 활발한 SNS 형태의 프로젝트를 진행하게 되었습니다.",
        mission: null,
    ...
    },
    {
        ...
        name: "Travel Away",
        show: true,
        intro: "코로나 이후 여행 수요의 증가로 각 국가의 기본 정보를 소개할 수 있는 웹페이지를 제작했습니다.",
        text2: "코로나 이후 여행 수요의 증가로 여행을 계획하는 사용자들을 위해 제작을 계획하게 된 프로젝트로서, \n각 국가의 여러 정보를 소개하는 웹페이지로 기본 정보, 여행 경보, 환율 등의 정보를 제공하며, 지속적으로 아이템 및 풍부한 정보를 담을 수 있는 웹 페이지가 될 수 있도록 지속적인 업데이트를 실행하고 있습니다.",
        mission: null,
    ...
    },
    {
        ...
        name: "Youtube Clone",
        show: true,
        intro: "유튜브를 클로닝 한 프로젝트입니다. 가장 활발히 사용되는 웹사이트를 클로닝 함으로서 유튜브 UI를 직접 구현했습니다",
        text2: "현재 가장 많이 사용되고 있는 페이지 중 하나인 유튜브를 Youtube API를 사용하여 유튜브에 있는 각각의 페이지 및 여러 기능들을 구현한 프로젝트입니다. 이 프로젝트를 통해 API를 다루는 능력을 향상시키게 되었으며, 프로젝트를 진행하면서 이전에 작업했던 프로젝트보다 훨씬 더 많은 오류 및 요구사항에 부딪히고\n이를 능숙하게 해결하여 여러 요구사항에 대해 다양한 방식으로 접근하여 조건을 만족시킬 수 있는 코드를 구현하는 능력을 키운 프로젝트입니다.",
        mission: null,
