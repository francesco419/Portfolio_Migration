...
#### 결과적으로 SCSS와 SVG를 결합하여 보다 효과적으로 요구사항을 수행했습니다.`
  ...
  {
    name: 'MindMap',
    work:['https://velog.io/@francesco419/%EB%A7%88%EC%9D%B8%EB%93%9C%EB%A7%B5-230530','https://github.com/francesco419/BrainBomb'],
    data: [
      {
        title: '주요기능',
        info: [
    ...
    data: [
      ...
      },
      {
        ...
        info: [
          ...
          {
            subtitle:
              '**Lazy, Suspense를 적용한 코드 분할**을 통해 JS 번들링 ',
            detail: ''
          },
          {
            subtitle:
